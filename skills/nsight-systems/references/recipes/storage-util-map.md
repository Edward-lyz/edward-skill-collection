---
recipe: storage_util_map
display_name: Storage Metrics Heatmap
...
```yaml
moduleName: storage_util_map
displayName: Storage Metrics Heatmap
description: This recipe displays heatmaps of storage devices metrics.
arguments:
- name: INPUT
  cliOption: --input
  type: process_input
