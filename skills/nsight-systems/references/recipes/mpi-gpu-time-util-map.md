---
recipe: mpi_gpu_time_util_map
display_name: MPI and GPU Time Utilization Heatmap
...
This recipe calculates the percentage of time that CUDA kernels were running
 and MPI communication was active, as well as their overlap. Note that this
 refers to time utilization and does not account for the actual hardware
 resource utilization.

```yaml
moduleName: mpi_gpu_time_util_map
displayName: MPI and GPU Time Utilization Heatmap
description: |-
  This recipe calculates the percentage of time that CUDA kernels were running and MPI communication was active, as well as their overlap. Note that this refers to time utilization and does not account for the actual hardware resource utilization.
arguments:
- name: INPUT
  cliOption: --input
  type: process_input
