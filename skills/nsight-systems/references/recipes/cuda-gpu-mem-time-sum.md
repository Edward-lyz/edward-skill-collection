...
This recipe provides a summary of GPU memory operations and their execution
 times.

```yaml
moduleName: cuda_gpu_mem_time_sum
displayName: CUDA GPU MemOps Summary (by Time)
description: |-
