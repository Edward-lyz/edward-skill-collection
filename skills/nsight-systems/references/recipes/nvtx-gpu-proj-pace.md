---
recipe: nvtx_gpu_proj_pace
display_name: NVTX GPU Projection Pacing
...
This recipe investigates the progress and consistency of a particular NVTX range
 projected from the CPU onto the GPU, throughout the application.

```yaml
moduleName: nvtx_gpu_proj_pace
displayName: NVTX GPU Projection Pacing
description: |-
...
- name: NAME
  ...
  type: string
  title: Kernel Name
  description: Name of the kernel used as delineator between iterations.
  required: true
  group: Kernel
- name: FILTER_TIME
