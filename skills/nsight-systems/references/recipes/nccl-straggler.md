---
recipe: nccl_straggler
display_name: NCCL Straggler
...
Analyze NCCL collective timing to identify ranks that repeatedly
 delay communicator progress.

```yaml
moduleName: nccl_straggler
displayName: NCCL Straggler
description: |-
  Analyze NCCL collective timing to identify ranks that repeatedly delay communicator progress.
type: stats
arguments:
- name: INPUT
  cliOption: --input
