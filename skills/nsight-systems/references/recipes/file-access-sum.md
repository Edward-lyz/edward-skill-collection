---
recipe: file_access_sum
display_name: Linux File Access Summary
source: installed-nsys/python/packages/nsys_recipe
---

# file_access_sum: Linux File Access Summary
...
This recipe provides a summary of file access statistics and Posix calls.

```yaml
moduleName: file_access_sum
displayName: Linux File Access Summary
description: |-
  This recipe provides a summary of file access statistics and Posix calls.
arguments:
- name: INPUT
