...
This recipe calculates the percentage of SM Active, SM Issue, and Tensor Active
 metrics.

```yaml
moduleName: gpu_metric_util_map
displayName: GPU Metric Utilization Heatmap
description: |-
