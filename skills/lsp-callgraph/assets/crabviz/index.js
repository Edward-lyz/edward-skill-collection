...
const GraphGeneratorFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_graphgenerator_free(ptr >>> 0, 1));
...
export class GraphGenerator {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        GraphGeneratorFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_graphgenerator_free(ptr, 0);
    }
    /**
     * @param {string} lang
    ...
    constructor(lang, filter) {
        ...
        const ret = wasm.graphgenerator_new(ptr0, len0, filter);
        this.__wbg_ptr = ret >>> 0;
        GraphGeneratorFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @param {string} path
     * @returns {boolean}
     */
    should_filter_out_file(path) {
        const ptr0 = passStringToWasm0(path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.graphgenerator_should_filter_out_file(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
     * @param {string} path
    ...
    add_file(path, symbols) {
        const ptr0 = passStringToWasm0(path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.graphgenerator_add_file(this.__wbg_ptr, ptr0, len0, symbols);
        return ret !== 0;
    }
    /**
     * @param {string} path
    ...
    add_incoming_calls(path, position, calls) {
        const ptr0 = passStringToWasm0(path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.graphgenerator_add_incoming_calls(this.__wbg_ptr, ptr0, len0, position, calls);
    }
    /**
     * @param {string} path
     * @param {any} position
    ...
    add_outgoing_calls(path, position, calls) {
        const ptr0 = passStringToWasm0(path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.graphgenerator_add_outgoing_calls(this.__wbg_ptr, ptr0, len0, position, calls);
    }
    /**
     * @param {string} path
     * @param {any} position
    ...
    add_interface_implementations(path, position, locations) {
        const ptr0 = passStringToWasm0(path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.graphgenerator_add_interface_implementations(this.__wbg_ptr, ptr0, len0, position, locations);
    }
    /**
     * @returns {any}
     */
    gen_graph() {
        const ret = wasm.graphgenerator_gen_graph(this.__wbg_ptr);
        return ret;
    }
}
